...
//-------------------------
enum Texture {
	HELP = 0, PLAY, PLAYER, KILLING_PLAYER, SOUND,UN_SOUND, START_VIEW, EXIT, INSTRUCTIONS, SEA, SETTING_VIEW, SETTING, CLOCKPICTURE,BACK,BALL,SPIDER,SMART_SPIDER, HEART,
